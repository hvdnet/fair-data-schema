...
// Version: dev
// Run:     uv run python scripts/generate_rust.py --version dev
//
...
pub struct SchemaNode {
    ...
    #[serde(rename = "fair:resourceType", skip_serializing_if = "Option::is_none")]
    ...
    pub fair_contributors: Option<Vec<Value>>,
    ...
    #[serde(rename = "fair:structureType", skip_serializing_if = "Option::is_none")]
    pub fair_structure_type: Option<String>,
    #[serde(rename = "fair:quality", skip_serializing_if = "Option::is_none")]
    pub fair_quality: Option<Vec<Value>>,
    #[serde(rename = "fair:classification", skip_serializing_if = "Option::is_none")]
    pub fair_classification: Option<I18nString>,
    #[serde(rename = "fair:classificationRef", skip_serializing_if = "Option::is_none")]
    pub fair_classification_ref: Option<Vec<Value>>,
    #[serde(rename = "fair:measurementUnit", skip_serializing_if = "Option::is_none")]
    pub fair_measurement_unit: Option<I18nString>,
    #[serde(rename = "fair:measurementUnitRef", skip_serializing_if = "Option::is_none")]
    pub fair_measurement_unit_ref: Option<String>,
    #[serde(rename = "fair:measurementTechnique", skip_serializing_if = "Option::is_none")]
    pub fair_measurement_technique: Option<I18nString>,
    #[serde(rename = "fair:measurementTechniqueRef", skip_serializing_if = "Option::is_none")]
    pub fair_measurement_technique_ref: Option<String>,
    ...
    #[serde(rename = "fair:measurementScale", skip_serializing_if = "Option::is_none")]
    pub fair_measurement_scale: Option<I18nString>,
    #[serde(rename = "fair:measurementScaleRef", skip_serializing_if = "Option::is_none")]
    pub fair_measurement_scale_ref: Option<String>,
    ...
    #[serde(rename = "fair:variableRef", skip_serializing_if = "Option::is_none")]
    pub fair_variable_ref: Option<String>,
    ...
    #[serde(rename = "fair:sentinel", skip_serializing_if = "Option::is_none")]
