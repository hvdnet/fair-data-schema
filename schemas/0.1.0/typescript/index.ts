...
// Version: 0.1.0
// Run:     uv run python scripts/generate_typescript.py --version 0.1.0
//
...
export const SchemaNodeSchema: z.ZodType<SchemaNode> = z.lazy(() =>
  z.object({
    ...
    "fair:unit": I18nStringSchema.optional(),
    "fair:unitRef": z.string().optional(),
    ...
    "fair:classification": z.array(z.any()).optional(),
  }).passthrough()
);
...
export const DatasetSchemaSchema: z.ZodType<DatasetSchema> = SchemaNodeSchema.and(
  z.object({
    $schema: z.string().default("https://highvaluedata.net/fair-data-schema/0.1.0").optional(),
  })
);
