...
*   **Product Level**: `title: "National Census 2024"`, `fair:description: "..."`.
*   **Table Level**: `title: "Household Table"`.
*   **Property Level**: `title: "Geographic Region"`, `fair:conceptRef: "..."`.
...
*   **At the Table (The Resource)**: Each nested array can have its own `fair:population` and `fair:unitType`.
    *   The `households` list is limited to a population of "Private households".
    *   The `persons` list is limited to a population of "All residents".
